...
Timestamp: 2026-06-03T18:03:02Z
...
- TDI Factor Gmail heartbeat automation: active as hourly-tdi-factor-gmail-status, now scheduled every two hours with rrule FREQ=HOURLY;INTERVAL=2.
- Immediate material-event email rule remains in force, subject to no duplicate spam.
- PFID present in environment: yes, per prior local check.
- COINBASE_KEY_FILE present in environment: yes, per prior local check.

Current blocker:
- Current blocker is green_breadth, not Profit Score tuning.
...
- Green breadth is failing: cache green_ratio=0.1852 vs min=0.8500, green_shortfall=0.6648; runtime mbr=0.5667 vs min=0.8500.
- Entry coverage is still thin: liquid_dmid_overlap=2 and liquid_dmid_spread_tob_overlap=0.
- Book/cache gap remains relevant: book_metric_source_present_ratio=0.0534; liquid dmid candidates HYPE-USD and OPN-USD still miss tob/spread/trough coverage.
- No Profit Score tuning applied while dryopen=0.
...
- Automation updated: hourly-tdi-factor-gmail-status cadence changed from hourly to every two hours.
...
- Confirmed relay file is readable on branch codex/cloud-ready-koko-bot.
- Set RELAY_FILE_VISIBLE=yes in this file.
- Updated Gmail reporting cadence from every hour to every two hours.
- Preserved immediate material-event reporting requirement and no-duplicate/no-sent-email-spam rule.
...
- Latest close evidence: LINK-USD entry_mid=8.307 at 2026-06-03T17:27:38Z; exit_mid=8.3055 at 2026-06-03T17:54:28Z; exit_reason=stale_loaded; pnl_bps=-1.8057; pnl_usd=-0.00054171.
...
- cache green_ratio=0.1852, min_green_ratio=0.8500.
- liquid_subset=13, liquid_min=10.
